<div class="login">
        <div class="col-4 bg-white border rounded p-4 shadow-sm">
            <form method="post" action="assets/php/actions.php?signup">
                ...
                <h1 class="h5 mb-3 fw-normal"><b>Create new account</b></h1>
                <div class="d-flex">
                    <div class="form-floating mt-1 col-6 ">
                    <input type="text" name="firstname" value="<?=showFormData('firstname')?>" class="form-control rounded-0" placeholder="FirstName">
                        <label for="floatingInput">First Name</label>
                    </div>
                    <div class="form-floating mt-1 col-6">
                        <input type="text" name="lastname" value="<?=showFormData('lastname')?>" class="form-control rounded-0" placeholder="LastName">
