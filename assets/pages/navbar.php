...
<nav class="navbar navbar-expand-lg navbar-light bg-white border">
        <div class="container col-9 d-flex justify-content-between">
            <div class="d-flex justify-content-between col-8">
                ...
                <form class="d-flex">
                    <input class="form-control me-2" type="search" placeholder="find your friends"
                        aria-label="Search">
            ...
            <ul class="navbar-nav  mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button"
                        ...
                        <img src="assets/images/profile/<?=$user['profilepic']?>" alt="" height="30" class="rounded-circle border">
                    </a>
